...
class SequelizeMeal extends Model<InferAttributes<SequelizeMeal>,
...
SequelizeMeal.init({
  ...
  strMeal: { type: DataTypes.STRING, allowNull: false },
  strDrinkAlternate: { type: DataTypes.STRING, allowNull: true },
  strCategory: { type: DataTypes.STRING, allowNull: true },
  strArea: { type: DataTypes.STRING, allowNull: true },
  strInstructions: { type: DataTypes.TEXT, allowNull: false },
  strMealThumb: { type: DataTypes.STRING, allowNull: false },
  strTags: { type: DataTypes.STRING, allowNull: true },
  strYoutube: { type: DataTypes.STRING, allowNull: true },
  strIngredient1: { type: DataTypes.STRING, allowNull: false },
  ...
  strSource: { type: DataTypes.STRING, allowNull: true },
  dateModified: { type: DataTypes.STRING, allowNull: true },
}, {
  sequelize: db,
  modelName: 'meals',
  timestamps: false,
